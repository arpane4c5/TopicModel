...
from folder videos and dump to disk (HMDB51).

Feature : Farneback Dense Optical Flow: Magnitudes and Angles (with grid_size)
Execution Time:  secs (Njobs=10, batch=10) (nVids = ) grid=20
Execution Time:  secs (Njobs=10, batch=10) (nVids=) grid=40
Execution Time:  secs (Njobs=10, batch=10) (nVid=) grid=30
"""
...
if __name__=='__main__':
    ...
    # Server params
    srcPath = "/home/arpan/DATA_Drive2/video_datasets/hmdb51/videos"
    destPath = "/home/arpan/VisionWorkspace/TopicModel/OF_npy_grid"+str(gridSize)
    # localhost params
    if not os.path.exists(srcPath):
        srcPath = "/home/hadoop/VisionWorkspace/VideoData/hmdb51/videos"
        destPath = "/home/hadoop/VisionWorkspace/TopicModel/OF_npy_grid"+str(gridSize)
